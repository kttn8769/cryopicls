...
cryosparc_consensus = 'tests/cryosparc_consensus/P2_J744_particles.csg'
...
def test_cryosparc_threedvar():
    ...
    com = f"cryopicls_clustering.py k-means --cryosparc --threedvar-csg {cryosparc_threedvar} --random-state 1 --output-dir {output_dir_root}/test_cryosparc_threedvar"
    sys.argv = com.split()
    main()

    print('\n\nWith component selection --threedvar-num-components 3')
    com = f"cryopicls_clustering.py k-means --cryosparc --threedvar-csg {cryosparc_threedvar} --threedvar-num-components 3 --random-state 1 --output-dir {output_dir_root}/test_cryosparc_threedvar_components3"
    sys.argv = com.split()
    main()
